...
| 9   | Service (systemd user / tâche planifiée / launchd) + désinstallation | 🟡   | **Désinstallation faite** : `hive desinstaller`, inventaire par défaut, `.env` et la base jamais touchés (ADR 0004), plus une garde qui rougit si une écriture apparaît hors du dossier. **Le service reste à faire.** |
| 10  | Dockerfile, compose, GHCR signé, sauvegarde SQLite                   | 🟡   | GHCR/cosign **bloqués** ; Dockerfile et compose, non — et absents.                                                                                                                                                     |
| 11  | Docs FR/EN, CHANGELOG, `docs/INSTALLATION.md`                        | ✅   | READMEs, CHANGELOG et `docs/INSTALLATION.md` — les trois présents et tenus.                                                                                                                                            |

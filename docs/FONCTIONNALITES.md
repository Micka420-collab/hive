...
| 🐝 **Rayon**      | **Le code du projet, lisible** : arbre de fichiers, éditeur coloré, aperçu du site produit, retouche → tâche (avec filet `avant_retouche`), et **timeline de sauvegardes** (restaurer ouvre une tâche).                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                         |

...
## A. Le code tient — ✅ mesuré en CI (arbre `12c4dd5`, 22 septembre 2026, `ubuntu-latest` / Node 24)
...
| Suite de bancs           | `npm test` (vitest run)                                  | ✅ **5857** (5845 verts, 12 ignorés, **0 rouge**)                                                                                                                                                                                                                                                                                                                                                                                                                 |

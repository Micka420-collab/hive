...
## A. Le code tient — ✅ mesuré (arbre `9cc3864` + la Reine qui ne répond plus à côté, 24 août 2026)
...
| Suite de bancs           | `npm test` (vitest run)                                  | ✅ **5366** (5358 verts, 8 ignorés, **0 rouge**)                                                                                                                                                                                                                                                                                                                                                                                                                  |

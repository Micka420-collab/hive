...
## A. Le code tient — ✅ mesuré en CI (arbre `983dea3`, 23 septembre 2026, `ubuntu-latest` / Node 24)
...
| Suite de bancs           | `npm test` (vitest run)                                  | ✅ **5876** (5864 verts, 12 ignorés, **0 rouge**)                                                                                                                                                                                                                                                                                                                                                                                                                 |

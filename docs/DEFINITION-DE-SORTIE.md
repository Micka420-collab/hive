...
## A. Le code tient — ✅ mesuré en CI (arbre `56ec010a`, 24 septembre 2026, `ubuntu-latest` / Node 24)
...
| Suite de bancs           | `npm test` (vitest run)                                  | ✅ **5925** (5911 verts, 14 ignorés, **0 rouge**)                                                                                                                                                                                                                                                                                                                                                                                                                 |
| Trois OS × Node 24       | matrice CI `ubuntu` / `windows` / `macos`                | ✅ vertes (run `35966786191`)                                                                                                                                                                                                                                                                                                                                                                                                                                     |

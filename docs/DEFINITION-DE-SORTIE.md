...
## A. Le code tient — ✅ mesuré en CI (arbre `e371acca808ee5b517a2a2ba55dab48796460005`, 25 septembre 2026, `ubuntu-latest` / Node 24)
...
| Suite de bancs           | `npm test` (vitest run)                                  | ✅ **6031** (6017 verts, 14 ignorés, **0 rouge**)                                                                                                                                                                                                                                                                                                                                                                                                                 |

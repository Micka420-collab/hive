...
## A. Le code tient — ✅ mesuré en CI (arbre `ebbff8b1`, 24 septembre 2026, `ubuntu-latest` / Node 24)
...
| Trois OS × Node 24       | matrice CI `ubuntu` / `windows` / `macos`                | ✅ vertes (run `35961893577`)                                                                                                                                                                                                                                                                                                                                                                                                                                     |

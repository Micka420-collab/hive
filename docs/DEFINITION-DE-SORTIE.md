...
## A. Le code tient — ✅ mesuré en CI (arbre `c50b80e`, 21 septembre 2026, `ubuntu-latest` / Node 24)
...
| Suite de bancs           | `npm test` (vitest run)                                  | ✅ **5827** (5815 verts, 12 ignorés, **0 rouge**)                                                                                                                                                                                                                                                                                                                                                                                                                 |

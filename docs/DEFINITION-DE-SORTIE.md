...
## A. Le code tient — ✅ mesuré en CI (arbre `90576534478ee46304cb43ae135b219e7008127d`, 25 septembre 2026, `ubuntu-latest` / Node 24)
...
| Suite de bancs           | `npm test` (vitest run)                                  | ✅ **6002** (5988 verts, 14 ignorés, **0 rouge**)                                                                                                                                                                                                                                                                                                                                                                                                                 |
| Trois OS × Node 24       | matrice CI `ubuntu` / `windows` / `macos`                | ⏳ en cours (run `36188284166` ; matrice de tests passée, garde des compteurs restampée dans cette branche)                                                                                                                                                                                                                                                                                                                                                       |

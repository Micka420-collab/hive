...
## A. Le code tient — ✅ mesuré (arbre `9cd0bee` + les constats d’outils du nœud jusqu’à l’écran, 23 août 2026)
...
| Suite de bancs           | `npm test` (vitest run)                                  | ✅ **5309** (5301 verts, 8 ignorés, **0 rouge**)                                                                                                                                                                                                                                                                                                                                                                                                                  |

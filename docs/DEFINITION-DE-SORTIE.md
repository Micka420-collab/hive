...
## A. Le code tient — ✅ mesuré en CI (arbre `4a28abc`, 23 septembre 2026, `ubuntu-latest` / Node 24)
...
| Suite de bancs           | `npm test` (vitest run)                                  | ✅ **5880** (5868 verts, 12 ignorés, **0 rouge**)                                                                                                                                                                                                                                                                                                                                                                                                                 |

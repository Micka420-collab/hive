...
## A. Le code tient — ✅ mesuré en CI (arbre `977d17cffdd6dadbeca20999c30b6e7251cdc84b`, 25 septembre 2026, `ubuntu-latest` / Node 24)
...
| Suite de bancs           | `npm test` (vitest run)                                  | ✅ **5990** (5976 verts, 14 ignorés, **0 rouge**)                                                                                                                                                                                                                                                                                                                                                                                                                 |
| Trois OS × Node 24       | matrice CI `ubuntu` / `windows` / `macos`                | ⏳ en cours (run `36188549099` ; matrice de tests passée, garde des compteurs restampée dans cette branche)                                                                                                                                                                                                                                                                                                                                                       |

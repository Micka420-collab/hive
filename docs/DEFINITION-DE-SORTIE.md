...
## A. Le code tient — ✅ mesuré en CI (arbre `9eb4ceb1`, 23 septembre 2026, `ubuntu-latest` / Node 24)
...
| Suite de bancs           | `npm test` (vitest run)                                  | ✅ **5919** (5906 verts, 13 ignorés, **0 rouge**)                                                                                                                                                                                                                                                                                                                                                                                                                 |
| Trois OS × Node 24       | matrice CI `ubuntu` / `windows` / `macos`                | ✅ vertes (run `35931627451`)                                                                                                                                                                                                                                                                                                                                                                                                                                     |

...
## A. Le code tient — ✅ mesuré en CI (arbre `cdaa1e0152e3df3596fac6cea2a0935ed1b1e0ad`, 25 septembre 2026, `ubuntu-latest` / Node 24)
...
| Suite de bancs           | `npm test` (vitest run)                                  | ✅ **5977** (5963 verts, 14 ignorés, **0 rouge**)                                                                                                                                                                                                                                                                                                                                                                                                                 |
| Trois OS × Node 24       | matrice CI `ubuntu` / `windows` / `macos`                | ⏳ en cours (run `36183275376` ; matrice de tests passée, garde des compteurs restampée dans cette branche)                                                                                                                                                                                                                                                                                                                                                       |

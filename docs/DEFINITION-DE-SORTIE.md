...
## A. Le code tient — ✅ mesuré en CI (arbre `574e596` + le banc des renvois des documents, 31 août 2026, `ubuntu-latest` / Node 24)
...
| Suite de bancs           | `npm test` (vitest run)                                  | ✅ **5498** (5490 verts, 8 ignorés, **0 rouge**)                                                                                                                                                                                                                                                                                                                                                                                                                  |
| Trois OS × Node 24       | matrice CI `ubuntu` / `windows` / `macos`                | ✅ vertes (run `33312462566`, hors badge)                                                                                                                                                                                                                                                                                                                                                                                                                         |

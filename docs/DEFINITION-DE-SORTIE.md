...
## A. Le code tient — ✅ mesuré en CI (arbre `e969945`, 22 septembre 2026, `ubuntu-latest` / Node 24)
...
| Suite de bancs           | `npm test` (vitest run)                                  | ✅ **5853** (5841 verts, 12 ignorés, **0 rouge**)                                                                                                                                                                                                                                                                                                                                                                                                                 |
| Trois OS × Node 24       | matrice CI `ubuntu` / `windows` / `macos`                | ✅ vertes (run `35756692937`)                                                                                                                                                                                                                                                                                                                                                                                                                                     |

...
## A. Le code tient — ✅ mesuré en CI (arbre `6e5d9b3b81a3c6864a1bfc844c294a15e4c1f302`, 24 septembre 2026, `ubuntu-latest` / Node 24)
...
| Suite de bancs           | `npm test` (vitest run)                                  | ✅ **5931** (5917 verts, 14 ignorés, **0 rouge**)                                                                                                                                                                                                                                                                                                                                                                                                                 |
| Trois OS × Node 24       | matrice CI `ubuntu` / `windows` / `macos`                | ✅ vertes (run `35998627710`)                                                                                                                                                                                                                                                                                                                                                                                                                                     |

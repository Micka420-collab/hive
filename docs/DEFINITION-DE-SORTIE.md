...
## A. Le code tient — ✅ mesuré (arbre `5e1e154` + le réseau coupé dans les bancs de rendu, 24 août 2026)
...
| Suite de bancs           | `npm test` (vitest run)                                  | ✅ **5399** (5391 verts, 8 ignorés, **0 rouge**)                                                                                                                                                                                                                                                                                                                                                                                                                  |

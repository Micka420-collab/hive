...
## A. Le code tient — ✅ mesuré (arbre `28c7c2c` + la version 0.3.0 et la fraîcheur, 24 août 2026)
...
| Suite de bancs           | `npm test` (vitest run)                                  | ✅ **5427** (5419 verts, 8 ignorés, **0 rouge**)                                                                                                                                                                                                                                                                                                                                                                                                                  |

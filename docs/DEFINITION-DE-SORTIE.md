...
## A. Le code tient — ✅ mesuré en CI (arbre `2e271ba`, 22 septembre 2026, `ubuntu-latest` / Node 24)
...
| Trois OS × Node 24       | matrice CI `ubuntu` / `windows` / `macos`                | ✅ vertes (run `35749738085`, hors badge)                                                                                                                                                                                                                                                                                                                                                                                                                         |

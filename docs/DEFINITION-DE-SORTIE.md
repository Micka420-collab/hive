...
## A. Le code tient — ✅ mesuré (arbre `0878295` + la morsure Windows du `.pathname` et la garde qui balaie, 23 août 2026)
...
| Suite de bancs           | `npm test` (vitest run)                                  | ✅ **5274** (5266 verts, 8 ignorés, **0 rouge**)                                                                                                                                                                                                                                                                                                                                                                                                                  |

...
## A. Le code tient — ✅ mesuré en CI (arbre `ab3173e2a31669339aab8b5bc952dca8127c50eb`, 25 septembre 2026, `ubuntu-latest` / Node 24)
...
| Suite de bancs           | `npm test` (vitest run)                                  | ✅ **6054** (6040 verts, 14 ignorés, **0 rouge**)                                                                                                                                                                                                                                                                                                                                                                                                                 |

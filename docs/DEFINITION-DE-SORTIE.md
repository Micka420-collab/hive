...
## A. Le code tient — ✅ mesuré en CI (arbre `bd6532a`, 22 septembre 2026, `ubuntu-latest` / Node 24)
...
| Suite de bancs           | `npm test` (vitest run)                                  | ✅ **5854** (5842 verts, 12 ignorés, **0 rouge**)                                                                                                                                                                                                                                                                                                                                                                                                                 |
| Trois OS × Node 24       | matrice CI `ubuntu` / `windows` / `macos`                | ✅ vertes (run `35783258967`)                                                                                                                                                                                                                                                                                                                                                                                                                                     |

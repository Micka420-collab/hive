...
## A. Le code tient — ✅ mesuré en CI (arbre `77b0629a1afa583b3f48c3476d5702c20a866a85`, 25 septembre 2026, `ubuntu-latest` / Node 24)
...
| Suite de bancs           | `npm test` (vitest run)                                  | ✅ **6028** (6014 verts, 14 ignorés, **0 rouge**)                                                                                                                                                                                                                                                                                                                                                                                                                 |

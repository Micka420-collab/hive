...
## A. Le code tient — ✅ mesuré en CI (arbre `8a6ce7d`, 22 septembre 2026, `ubuntu-latest` / Node 24)
...
| Suite de bancs           | `npm test` (vitest run)                                  | ✅ **5849** (5837 verts, 12 ignorés, **0 rouge**)                                                                                                                                                                                                                                                                                                                                                                                                                 |
| Trois OS × Node 24       | matrice CI `ubuntu` / `windows` / `macos`                | ✅ vertes (run `35750829903`, tête `8a6ce7da`)                                                                                                                                                                                                                                                                                                                                                                                                                         |

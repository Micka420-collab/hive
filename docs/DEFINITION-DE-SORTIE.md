...
## A. Le code tient — ✅ mesuré (arbre `068760f` + le catalogue d’installation ramené à une seule source, 23 août 2026)
...
| Suite de bancs           | `npm test` (vitest run)                                  | ✅ **5327** (5319 verts, 8 ignorés, **0 rouge**)                                                                                                                                                                                                                                                                                                                                                                                                                  |

...
## A. Le code tient — ✅ mesuré en CI (arbre `969e7ae3b869d0d1907655a864b8b81bd12718ae`, 25 septembre 2026, `ubuntu-latest` / Node 24)
...
| Suite de bancs           | `npm test` (vitest run)                                  | ✅ **5959** (5945 verts, 14 ignorés, **0 rouge**)                                                                                                                                                                                                                                                                                                                                                                                                                 |
| Trois OS × Node 24       | matrice CI `ubuntu` / `windows` / `macos`                | ⏳ en cours (run `36177247606` ; matrice de tests passée, garde des compteurs restampée dans cette branche)                                                                                                                                                                                                                                                                                                                                                       |

...
## A. Le code tient — ✅ mesuré en CI (arbre `791a1f9c0819984d442a2e6960ba5cad4735431b`, 24 septembre 2026, `ubuntu-latest` / Node 24)
...
| Suite de bancs           | `npm test` (vitest run)                                  | ✅ **5927** (5913 verts, 14 ignorés, **0 rouge**)                                                                                                                                                                                                                                                                                                                                                                                                                 |
| Trois OS × Node 24       | matrice CI `ubuntu` / `windows` / `macos`                | ✅ vertes (run `35992454848`, attempt 2)                                                                                                                                                                                                                                                                                                                                                                                                                          |

...
## A. Le code tient — ✅ mesuré en CI (arbre `d31b567e4bb9adc6ce41c92611fe07351415fa2d`, 25 septembre 2026, `ubuntu-latest` / Node 24)
...
| Suite de bancs           | `npm test` (vitest run)                                  | ✅ **5938** (5924 verts, 14 ignorés, **0 rouge**)                                                                                                                                                                                                                                                                                                                                                                                                                 |
| Trois OS × Node 24       | matrice CI `ubuntu` / `windows` / `macos`                | ✅ vertes (run `36120887208`)                                                                                                                                                                                                                                                                                                                                                                                                                                     |

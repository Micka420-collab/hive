...
| Rien de neuf n'est nu    | `npm run loupe` (mutation sur le diff ajouté)            | ✅ quatre terrains, chacun sur base épinglée : horloge — affichage (`1b93c44`, 18 examinées → 2 nues), la note (`6379854`, 17 → 3 nues), la file (`6c6c52b`, 2 → **rien de nu**) ; **butinage** — le transport (`ba07327`, 19 → 4 nues). **9 nues, 9 fermées, contre-rejeu 9/9** (§ terrain, `docs/ETAPES.md`) |

...
## A. Le code tient — ✅ mesuré (arbre `13bfda3` + ce commit, 23 août 2026)
...
| Suite de bancs           | `npm test` (vitest run)                                  | ✅ **4958** (4950 verts, 8 ignorés, **0 rouge**)                                                                                                                                                                                                                                                                                                            |
...
| Rien de neuf n'est nu    | `npm run loupe` (mutation sur le diff ajouté)            | ✅ cinq terrains, chacun sur base épinglée : horloge — affichage (`1b93c44`, 18 examinées → 2 nues), la note (`6379854`, 17 → 3 nues), la file (`6c6c52b`, 2 → **rien de nu**) ; **butinage** — le transport (`ba07327`, 19 → 4 nues), le déballage (`13bfda3`, 12 → **rien de nu**). **9 nues, 9 fermées, contre-rejeu 9/9** (§ terrain, `docs/ETAPES.md`) |

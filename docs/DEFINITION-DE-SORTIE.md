...
## A. Le code tient — ✅ mesuré (arbre `82f045c` + la ruche qui sait enfin ce qu’elle fait tourner, 24 août 2026)
...
| Suite de bancs           | `npm test` (vitest run)                                  | ✅ **5396** (5388 verts, 8 ignorés, **0 rouge**)                                                                                                                                                                                                                                                                                                                                                                                                                  |

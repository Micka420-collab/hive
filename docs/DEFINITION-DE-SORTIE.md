...
## A. Le code tient — ✅ mesuré (arbre `727859b` + #344 fusionnée, couverte et balayée, 23 août 2026)
...
| Suite de bancs           | `npm test` (vitest run)                                  | ✅ **5040** (5032 verts, 8 ignorés, **0 rouge**)                                                                                                                                                                                                                                                                                                                                                                                                                  |

...
## A. Le code tient — ✅ mesuré en CI (arbre `6956f65`, 23 septembre 2026, `ubuntu-latest` / Node 24)
...
| Suite de bancs           | `npm test` (vitest run)                                  | ✅ **5917** (5904 verts, 13 ignorés, **0 rouge**)                                                                                                                                                                                                                                                                                                                                                                                                                 |

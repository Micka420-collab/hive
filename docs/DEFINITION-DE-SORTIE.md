...
## A. Le code tient — ✅ mesuré en CI (arbre `2cf6e2223473a5305a624a9b411a07f95dac787a`, 25 septembre 2026, `ubuntu-latest` / Node 24)
...
| Suite de bancs           | `npm test` (vitest run)                                  | ✅ **6042** (6028 verts, 14 ignorés, **0 rouge**)                                                                                                                                                                                                                                                                                                                                                                                                                 |

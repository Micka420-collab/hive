...
## A. Le code tient — ✅ mesuré en CI (arbre `bd42203cb031d72f0e5d807de95ecb6ca9d2181a`, 24 septembre 2026, `ubuntu-latest` / Node 24)
...
| Suite de bancs           | `npm test` (vitest run)                                  | ✅ **5936** (5922 verts, 14 ignorés, **0 rouge**)                                                                                                                                                                                                                                                                                                                                                                                                                 |
| Trois OS × Node 24       | matrice CI `ubuntu` / `windows` / `macos`                | ✅ vertes (run `36005621032`)                                                                                                                                                                                                                                                                                                                                                                                                                                     |

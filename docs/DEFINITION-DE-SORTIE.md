...
## A. Le code tient — ✅ mesuré en CI (arbre `7fa7d08`, 23 septembre 2026, `ubuntu-latest` / Node 24)
...
| Suite de bancs           | `npm test` (vitest run)                                  | ✅ **5916** (5903 verts, 13 ignorés, **0 rouge**)                                                                                                                                                                                                                                                                                                                                                                                                                 |
| Trois OS × Node 24       | matrice CI `ubuntu` / `windows` / `macos`                | ✅ vertes (run `35789544618`)                                                                                                                                                                                                                                                                                                                                                                                                                                     |

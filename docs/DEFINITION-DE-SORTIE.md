...
## A. Le code tient — ✅ mesuré (arbre `8de5e59` + la présence sans production et sa garde de course, 23 août 2026)
...
| Suite de bancs           | `npm test` (vitest run)                                  | ✅ **5325** (5317 verts, 8 ignorés, **0 rouge**)                                                                                                                                                                                                                                                                                                                                                                                                                  |

...
## A. Le code tient — ✅ mesuré en CI (arbre `b61c86d`, 23 septembre 2026, `ubuntu-latest` / Node 24)
...
| Suite de bancs           | `npm test` (vitest run)                                  | ✅ **5909** (5896 verts, 13 ignorés, **0 rouge**)                                                                                                                                                                                                                                                                                                                                                                                                                 |

...
## A. Le code tient — ✅ mesuré en CI (arbre `677f6248`, 23 septembre 2026, `ubuntu-latest` / Node 24)
...
| Trois OS × Node 24       | matrice CI `ubuntu` / `windows` / `macos`                | ✅ vertes (run `35959836162`)                                                                                                                                                                                                                                                                                                                                                                                                                                     |

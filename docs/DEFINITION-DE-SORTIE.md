...
## A. Le code tient — ✅ mesuré en CI (arbre `313196dcf9c58d98403f7dae2a317313c04263df`, 25 septembre 2026, `ubuntu-latest` / Node 24)
...
| Suite de bancs           | `npm test` (vitest run)                                  | ✅ **6048** (6034 verts, 14 ignorés, **0 rouge**)                                                                                                                                                                                                                                                                                                                                                                                                                 |

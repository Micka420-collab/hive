...
## A. Le code tient — ✅ mesuré en CI (arbre `0dd992beabcef5f717b3eeb3871b0ccb1a6392d8`, 25 septembre 2026, `ubuntu-latest` / Node 24)
...
| Suite de bancs           | `npm test` (vitest run)                                  | ✅ **6016** (6002 verts, 14 ignorés, **0 rouge**)                                                                                                                                                                                                                                                                                                                                                                                                                 |

...
| 🐝 **The Comb**    | **The project's code, readable**: file tree, highlighted editor, preview of the site produced, edit → task, and a **checkpoint timeline** (restore opens a task). |
